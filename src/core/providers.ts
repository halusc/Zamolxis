...
export const PROVIDERS: ProviderDef[] = [
  ...
  { id: 'github', label: 'GitHub Models', kind: 'free', baseUrl: 'https://models.github.ai/inference', model: 'openai/gpt-4o-mini', envKey: 'GITHUB_MODELS_TOKEN', freeDaily: 150, signup: 'https://github.com/marketplace/models', note: 'Free GPT-4o/4.1/o-series via a GitHub token (rate-limited by your Copilot tier).', strong: true },
  // ── Paid (metered; used only if you add them to the routing order) ──
  { id: 'openai', label: 'OpenAI', kind: 'paid', baseUrl: 'https://api.openai.com/v1', model: 'gpt-4o-mini', envKey: 'OPENAI_API_KEY', freeDaily: 1_000_000, signup: 'https://platform.openai.com/api-keys', note: 'Paid (gpt-4o-mini by default). Billed to your OpenAI account.' },
